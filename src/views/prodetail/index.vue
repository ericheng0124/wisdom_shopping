  ...
  <div class="prodetail">
    ...
    >
      <div class="product">
        ...
        <div class="num-box">
          <span>数量</span>
          <!-- v-model 应用到组件上时，本质上就是 :value 和 @input 的简写 -->
...
export default {
  ...
  computed: {
    goodsId () {
      // 通过路由参数（/router/index.js）中约定的关键字id来获取传递的参数（动态路由传参）
  ...
  methods: {
    ...
    goPay () {
      ...
      // console.log('goodsId:', this.goodsId, 'goodsNum:', this.addCount, 'goods_sku_id:', this.detail.skuList[0].goods_sku_id)
      this.$router.push({
        path: '/pay',
        query: {
          mode: 'buyNow',
